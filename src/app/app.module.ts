...
import { GridlinesMenuItemComponent } from './views/advanced-menu/components/panels/gridlines/gridlines.component';
import { OptionSelectorComponent } from './views/advanced-menu/components/form-items/option-selector/option-selector.component';
import { ViewBoxComponent } from './views/advanced-menu/components/panels/viewbox/viewbox.component';
...
import { AboutComponent } from './views/advanced-menu/components/panels/about/about.component';
import { StrokeOptionsComponent } from './views/advanced-menu/components/panels/stroke-options/stroke-options.component';
...
import { FillOptionsComponent } from './views/advanced-menu/components/panels/fill-options/fill-options.component';
